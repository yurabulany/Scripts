...
packages=(wget alacritty git neofetch htop mpv vim neovim vifm fzf steam firefox thunderbird i3 i3lock redshift gxkb picom feh nitrogen dunst fish pavucontrol calibre transmission polybar zathura arandr j4-dmenu-desktop tmux flameshot darktable python ripgrep adobe-source-code-pro-fonts rtorrent xfce4-battery-plugin zoxide)
